...
public class Intake {
    private static final Claw claw = new Claw(Hardware.frontClaw, 0.15, 0.32);
    private static final Arm arm = new Arm(Hardware.frontClawAngle, 0.11-0.08, 0.71-0.05, 0.15-0.05,0.67);
