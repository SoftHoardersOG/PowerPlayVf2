...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(12, 0, 6.5,
            14.7);
    ...
    public static double GEAR_RATIO = 0.5*1.00625; // output (wheel) speed / input (motor) speed
    ...
    public static double MAX_ANG_VEL = Math.toRadians(400);
    public static double MAX_ANG_ACCEL = Math.toRadians(1);
