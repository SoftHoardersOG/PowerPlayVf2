...
public class FiveConeMidJunctionRightTrajectories {
    ...
    public static Trajectory IntakeTrajectory2(Pose2d pose2d) {
        return drive.trajectoryBuilder(pose2d)
                .lineToLinearHeading(new Pose2d(37, -15.2, Math.toRadians(-3.5)),//45
    ...
    public static Trajectory ParkTrajectory(Pose2d pose2d) {
        return drive.trajectoryBuilder(pose2d)
                .lineToLinearHeading(AutoRunFiveConeMidJunctionRight.detectedCase.getParkPoseRight(),
