...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 5.1; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -1.33858268; // in; offset of the lateral wheel
    public static double X_MULTIPLIER = 1.004;
